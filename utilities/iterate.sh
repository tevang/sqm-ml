...
#do
../EXEC_master_script.py -n_comp $n_comp -xtp 'A2A,ACHE,CATL,DHFR,EPHB4,GBA,GR,HIV1RT,JNK2,MDM2,MK2,PARP-1,PPARG,SARS-HCoV,SIRT2,TPA,TP' >& ../../sqm-ml_data/execution_dir${suffix}/results_${n_comp}D-UMAP_repeat${repeat}.log
