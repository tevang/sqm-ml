#!/usr/bin/env python
"""
This script carried out the evaluation of Glide SP and PM6/COSMO on all proteins in the
file "FEATURES_CSV" which is generated by "EXEC_master_script.py".
"""

import pandas as pd
from library.evaluate_model import evaluate_without_learning

FEATURES_CSV = '17_proteins_scaled_nonuniform_all_features.SF_P6C.SBBSB_Eint.SBSPB_complexE.HC_inner.FM_nofusion.RSP_0.8.OMT_8.0.OMSPN_0.KMNP_100.KMDP_1.000000.US_False.csv.gz'

best_sqm_df = pd.read_csv(FEATURES_CSV) \
