...
class Aurum():
    ...
    def write_SQM_Eint_cuby4_script(fname, pdb, method="pm6", solvent="cosmo2",
                                    trunc_cutoff=0, SQM_selection=None, amberhome=None):
...
calculation_%s_int:
  <<: *mopac_setup
        """ % tuple([method] + [solvent] * 18 + [lig_charge, rec_charge, method, solvent] +
                    [corrections_comment]*7 + [solvent])
