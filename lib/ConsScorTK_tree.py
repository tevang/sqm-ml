...
CRITERIA_REG = {"mse": _criterion.MSE, "friedman_mse": _criterion.FriedmanMSE,
                "mae": _criterion.MAE, "tau":"", "r":"", "rmse":"", "multi":""}
    ...
    def fit(self, X, y, sample_weight=None, check_input=True,
        ...
        if not isinstance(criterion, Criterion):
            if is_classification:
                ...
                # self.n_outputs_: number of classes (1 for Regression)
                #print("DEBUG: n_samples=", n_samples
                #print("DEBUG: self.n_outputs_=", self.n_outputs_
                #print("DEBUG: self.criterion=", self.criterion
                # n_outputs:    number of output values per sample. =1 (score) for Regression
                # n_samples:    number of observations/samples
