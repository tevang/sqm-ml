...
from sqmnn.library.features.ligand_descriptors.Chan2021_entropy_descriptors.functional_groups import GetCyclicAmide, GetCyclicEster, \
    GetCyclicThioamide
...
def compute_ring_flexibility(mol):
    """
