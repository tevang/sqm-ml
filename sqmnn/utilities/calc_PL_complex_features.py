...
try:
    from sqmnn.library.features.ligand_descriptors.pmapper_3D_pharmacophore import write_PMAPPER_to_csv, \
        gather_all_PMAPPER_to_one_csv
except ImportError:
    print("WARNING: PMAPPER module could not be found.")

try:
    from sqmnn.library.features.protein_ligand_complex_descriptors.PLEC import write_PLEC_to_csv, \
        gather_all_PLEC_to_one_csv
except ImportError:
    print("WARNING: PLEC module could not be found.")

from sqmnn.library.features.protein_ligand_complex_descriptors.descriptors_3D import calc_3D_complex_descriptors, \
    calc_3D_ligand_descriptors
from sqmnn.library.get_top_scored_Glide_complex_names import get_top_scored_Glide_complex_names
...
def launch_pipeline(args):
    ...
    if len(sel_logP_descriptors + sel_rotbond_descriptors + sel_bond_type_descriptors + sel_Chan_entropy_descriptors +
        ...
        from sqmnn.library.features.ligand_descriptors.descriptors_2D import calc_2D_descriptors
